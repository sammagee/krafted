    ...
    <main>
        <header class="px-12 text-gray-600 text-sm">
            <div class="flex items-center w-full md:w-2/3 md:max-w-6xl md:mx-auto pt-24 pb-4">
                <inertia-link class="flex items-center focus:outline-none hover:opacity-75 focus:opacity-75 rounded-full transition-all ease-in-out transition-slow"
                              :href="$route('home')">
                    <svg class="h-6 focus:outline-none text-primary-900 transition-all ease-in-out transition-slow" viewBox="0 0 397 106" fill="currentColor"
                ...
                <nav class="flex items-center">
                   <inertia-link class="ml-3 font-semibold text-primary-800 border-t-2 border-b-2 border-transparent hover:opacity-75 hover:border-primary-600 focus:opacity-75 focus:border-primary-600 transition-all ease-in-out transition-slow"
...
<!--                    <inertia-link class="ml-3 hover:text-black" :href="$route('work')">Support</inertia-link>-->
                    <contact-modal>
                        <button
                            class="flex items-center px-4 py-2 ml-4 font-semibold bg-primary-900 text-primary-500 rounded hover:shadow hover:opacity-75 focus:opacity-75 focus:shadow-outline focus:outline-none transition-all ease-in-out transition-slow"
                            slot="trigger"
                            slot-scope="{ present }"
                            @click="present">
